...
import com.kmarinos.businessemaildemo.StandByTextProviders;
import com.kmarinos.businessemaildemo.SupplierRegistry;
import com.kmarinos.businessemaildemo.exceptions.NoFallbackTextProviderDefined;
import com.kmarinos.businessemaildemo.exceptions.NoTextProviderSatisfiesCondition;
...
public class EmailTextProvider<T> {
    ...
    public EmailTextProvider<T> registerTextProvider(int sortingPosition, Supplier<? extends ContextualPartsTextProvider<T, ? extends MailContext>> textProviderSupplier) {
        boundedContext= (Class<T>) textProviderSupplier.get().conditionalContext.getClass();
